...
- #179 Add Nullability and Lightweight Generics for Xcode 7. Thanks @Adlai-Holler
- Unit tests for Media and User methods in InstagramEngine
- #177 Fix issue with pagination. Avoid percent-encoding twice. Thanks @snoonz
